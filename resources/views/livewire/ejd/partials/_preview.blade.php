...
<div class="print-container">
    ...
    <div class="mb-6 flex justify-center gap-4 print:hidden">
        ...
        <button type="button"
                ...
                class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-accent-400 hover:bg-accent-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-300 disabled:opacity-50 cursor-pointer transition-colors">
